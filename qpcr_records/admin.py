...
class test_overlapAdmin(admin.ModelAdmin):
    list_display = ('barcode', 'fake_name', 'ssp_id', 'ssp_well', 'sampling_date', 'sep_id', 'sep_well',
                    ...
                    'sample_extraction_technician2_lab', 'sample_extraction_technician2_institute', 'sample_bag_id',
                    'ms2_lot_id', 'epm_id', 'rna_extract_reagent_ids', 'kfr_id', 'rep_id', 'rep_well', 'rsp_id',
                    'rsp_well', 'knight_lab_frz_id', 'rwp_id', 'rwp_well', 'rna_extraction_technician',
